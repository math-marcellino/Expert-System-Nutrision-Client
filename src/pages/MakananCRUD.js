                ...
                <Modal isOpen={modalAddIsOpened} onRequestClose={() => setModalAddIsOpened(false)}>
                    ...
                    <form onSubmit={(e) => addMakanan(e)}>
                        ...
                        <div>
                            ...
                            <input type="number" ref={inputProtein} name="nilaiProtein" className="border w-3/5 rounded-xl focus:outline-none focus:border-green-400 py-2 px-3"/>   
                        </div>
                        <div>
                            <label htmlFor="nilaiLemak" className="mt-10 inline-block text-right w-1/6 font-bold text-xl mx-5">Nilai Lemak</label>
                            <input type="number" ref={inputLemak} name="nilaiLemak" className="border w-3/5 rounded-xl focus:outline-none focus:border-green-400 py-2 px-3"/>   
                        </div>
                        <div>
                            <label htmlFor="nilaiKarbo" className="mt-10 inline-block text-right w-1/6 font-bold text-xl mx-5">Nilai Karbohidrat</label>
                            <input type="number" ref={inputKarbo} name="nilaiKarbo" className="border w-3/5 rounded-xl focus:outline-none focus:border-green-400 py-2 px-3"/>   
                        </div>
                        <div>
                            <label htmlFor="nilaiTakaran" className="mt-10 inline-block text-right w-1/6 font-bold text-xl mx-5">Nilai Takaran</label>
                            <input type="number" ref={inputTakaran} name="nilaiTakaran" className="border w-3/5 rounded-xl focus:outline-none focus:border-green-400 py-2 px-3"/>   
                        </div>
                        <div>
                            <label htmlFor="nilaiKalori" className="mt-10 inline-block text-right w-1/6 font-bold text-xl mx-5">Nilai Kalori</label>
                            <input type="number" ref={inputKalori} name="nilaiKalori" className="border w-3/5 rounded-xl focus:outline-none focus:border-green-400 py-2 px-3"/>   
                        </div>
                ...
                <Modal isOpen={modalEditIsOpened} onRequestClose={() => setModalEditIsOpened(false)}>
                    ...
                    {dataMakananSpesifik && (
                        <form onSubmit={(e) => editMakanan(e)}>
                            ...
                            <div>
                                <label htmlFor="nilaiProtein" className="mt-10 inline-block text-right w-1/6 font-bold text-xl mx-5">Nilai Protein</label>
                                <input defaultValue={dataMakananSpesifik.Nilai_Protein} type="number" ref={editProtein} name="nilaiProtein" className="border w-3/5 rounded-xl focus:outline-none focus:border-green-400 py-2 px-3"/>   
                            </div>
                            <div>
                                <label htmlFor="nilaiLemak" className="mt-10 inline-block text-right w-1/6 font-bold text-xl mx-5">Nilai Lemak</label>
                                <input defaultValue={dataMakananSpesifik.Nilai_Lemak} type="number" ref={editLemak} name="nilaiLemak" className="border w-3/5 rounded-xl focus:outline-none focus:border-green-400 py-2 px-3"/>   
                            </div>
                            <div>
                                <label htmlFor="nilaiKarbo" className="mt-10 inline-block text-right w-1/6 font-bold text-xl mx-5">Nilai Karbohidrat</label>
                                <input defaultValue={dataMakananSpesifik.Nilai_Karbo} type="number" ref={editKarbo} name="nilaiKarbo" className="border w-3/5 rounded-xl focus:outline-none focus:border-green-400 py-2 px-3"/>   
                            </div>
                            <div>
                                <label htmlFor="nilaiTakaran" className="mt-10 inline-block text-right w-1/6 font-bold text-xl mx-5">Nilai Takaran</label>
                                <input defaultValue={dataMakananSpesifik.Nilai_Takaran} type="number" ref={editTakaran} name="nilaiTakaran" className="border w-3/5 rounded-xl focus:outline-none focus:border-green-400 py-2 px-3"/>   
                            </div>
                            <div>
                                <label htmlFor="nilaiKalori" className="mt-10 inline-block text-right w-1/6 font-bold text-xl mx-5">Nilai Kalori</label>
                                <input defaultValue={dataMakananSpesifik.Nilai_Kalori} type="number" ref={editKalori} name="nilaiKalori" className="border w-3/5 rounded-xl focus:outline-none focus:border-green-400 py-2 px-3"/>   
                            </div>
                            <div className="text-center mt-10">
                                <button className="p-3 bg-green-400 text-lg text-white rounded-md font-bold" type="submit">Submit</button>
                            </div>
